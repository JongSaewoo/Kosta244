...
@CrossOrigin(origins = "*")  //모든 다른 ip에서 접속 가능하도록 허용
           //origins = "http://192.168.0.13") -> 해당 ip만 나에게 접속가능하도록 허용
@RestController
...
public class BoardRestController {
	...
	public ResponseEntity<?> write(
			...
			,@RequestPart(required = false) MultipartFile imageFile ,Board board
